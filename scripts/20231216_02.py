...
class Config:
    data_path: str = "../data/"
    seed: int = 0
    experiment_name: str = "20231216_02"
    fold: int = 5
...
sample_n = train["session_id"].nunique()
ratings = torch.mm(
...
# %%
train.loc[train["session_id"] == train["session_id"].iloc[0]]

# %%
label.loc[label["session_id"] == train["session_id"].iloc[0]]
